  ...
  return (
    <Layout>
      ...
      <div className="container mx-auto px-4 py-6 sm:py-8 max-w-3xl">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 sm:mb-8 text-center text-primary">Your Profile</h1>
...
const InfoField = ({ label, value }) => (
  <div>
    ...
    <p className="text-sm sm:text-lg font-semibold text-white bg-gray-700 p-2 rounded mt-1 break-all">{value}</p>
  </div>
);
